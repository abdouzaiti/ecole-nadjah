...
const SplashScreen: React.FC<SplashScreenProps> = ({ onEnter }) => {
  ...
  return (
    <motion.div
      className="fixed inset-0 z-[100] bg-white flex flex-col items-center justify-center overflow-hidden h-[100dvh] touch-none overscroll-none"
      ...
      <div className="relative flex flex-col items-center justify-center w-full h-full pointer-events-none">
        ...
        >
          <img 
            src="/logo.png" 
            alt="Logo" 
            className="w-80 md:w-[40rem] h-auto drop-shadow-[0_10px_20px_rgba(0,0,0,0.05)]"
          />
        </motion.div>
          ...
          >
            <div className="flex flex-col items-center max-w-2xl mx-auto px-6">
              <motion.h1 
                ...
                className="text-3xl md:text-7xl font-packard font-extrabold text-white [text-shadow:_-2px_-2px_0_#1a3190,_2px_-2px_0_#1a3190,_-2px_2px_0_#1a3190,_2px_2px_0_#1a3190] mb-2"
              >
                ECOLE NADJAH
              </motion.h1>
              
              <div className="flex items-center gap-4 w-full mb-4 px-4 md:px-12">
            ...
            {phase === 'raised' && (
              ...
              >
                <Button
                  onClick={onEnter}
                  size="lg"
                  className="relative group overflow-hidden bg-gradient-to-br from-[#1a3190] via-[#1a3190] to-blue-800 text-white rounded-full px-8 py-5 md:px-12 md:py-8 text-lg md:text-2xl font-outfit shadow-[0_20px_50px_rgba(26,49_144,0.3)] flex items-center gap-4 transition-all duration-500 hover:shadow-[0_25px_60px_rgba(26,49,144,0.4)] hover:-translate-y-1 active:scale-95"
                >
